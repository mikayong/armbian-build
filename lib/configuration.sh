...
[[ -z $VENDOR ]] && VENDOR="M700"
[[ -z $ROOTPWD ]] && ROOTPWD="m700" # Must be changed @first login
[[ -z $MAINTAINER ]] && MAINTAINER="m700.com" # deb signature
[[ -z $MAINTAINERMAIL ]] && MAINTAINERMAIL="m700@m700.com" # deb signature
...
[[ -z $HOST ]] && HOST="m700" # set hostname to the board
cd "${SRC}" || exit
...
[[ -z $FIXED_IMAGE_SIZE ]] && FIXED_IMAGE_SIZE=1024
